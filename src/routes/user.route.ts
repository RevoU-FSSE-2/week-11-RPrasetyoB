...
userRoutes.delete('/v1/users/:id', authMiddleware.managerAuth, userController.deleteUser)
userRoutes.patch('/v1/users/:id', authMiddleware.authRole, userController.updateUser)
