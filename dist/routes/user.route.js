...
userRoutes.delete('/v1/users/:id', role_access_1.default.managerAuth, user_controller_1.deleteUser);
userRoutes.patch('/v1/users/:id', role_access_1.default.authRole, user_controller_1.updateUser);
